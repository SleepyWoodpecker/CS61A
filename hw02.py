...
def product(n, f):
    ...
    """
    "*** YOUR CODE HERE ***"
    # assigning 0 to sum means that if the sequence is not called, 0 is returned
    sum, k = 1, 1
    while k <= n:
        sum = sum * f(k)
        k += 1
...
def make_repeater(h, n):
    ...
    # accumulate is what will give me a complied result, while compose is what will help me stack the functions

    # skipping first, will come back to take a look later, I have close to zero idea how to do it now
    # return lambda x : accumulate(compose1, x, n, h)

##########################
# Just for fun Questions #
##########################
# had lots of help from chat gpt, have no idea what is even going on
